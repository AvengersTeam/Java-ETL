			...
			if( tagname.equals( "field" ) ) {
				...
				if( attributeValueName.equals( "Language" ) ) {
					...
					if( this.reader.getName().toString().equals( "value" ) ) {
						...
						String Lan;
						if( Language.equals( "spa" ) || Language.equals( "Espaï¿½ol" ) ) Lan = "http://www.lexvo.org/page/iso639-3/spa";
						else {
							if( Language.equals( "eng" ) || Language.equals( "Inglï¿½s" ) ) Lan = "http://www.lexvo.org/page/iso639-3/eng";
							else Lan = "";
						}
						expWriter.flush();
